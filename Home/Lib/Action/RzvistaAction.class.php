...
class RzvistaAction extends Action{
	...
	public function index(){
		...
		//这里需要表前缀
		$vcate=M()->query("select id,catename from ff_rzvcate where id in(select vid from ff_rzvista where vid>0 and pid={$_GET['id']})");
