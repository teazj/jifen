...
<script type="text/javascript" src="__PUBLIC__/Home/js/toptab.js"></script>
 ...
 <body>
    ...
    <div class="M_download">
    	<div class="Mcaut_tit"><a href="">首页</a> > <a href="">知识宝典</a></div>
        <div class="Minfor_left">
            <table cellpadding="o" cellspacing="0" border="0px none">
                <form>
                    <tr>
                        <td><input type="text" name="" value="" id="infor_key" class="infor_inp1" /></td>
                        <td><input type="button" name="" value="查询" class="infor_btn1" /></td>
                    </tr>
                </form>
            </table>
            <div class="infor_left">
            	<div class="wTab">
                    ...
                    <div class="T_Con">
                        <div id="my_tab_con0">
                            <div class="sgdt">
                            <?php if(is_array($list)): foreach($list as $key=>$li): ?><dl>
                        <dt><a href="<?php echo U('Index/RzColumn/news/',array('id'=>$li['id']),'');?>"><?php echo ($li['title']); ?></a></dt>
                        <dd>
                            <a href=""><img src="__PUBLIC__/images/rzimages/sgdt_img.jpg" /></a>
                            <p><?php echo ($li['content']); ?>
                            <span class="Dt_more"><a href=""></a></span></p>详细>>
                        </dd>
                ...
                <div class="sgdt">
                    <dl>
                        <dt><a href="">其他资料我们会帮您提供</a></dt>
                        <dd>
                            <a href=""><img src="__PUBLIC__/images/rzimages/sgdt_img.jpg" /></a>
                            <p>
                                做CD或发票用我们做CD或发票用我们做CD或发票用我们做CD或发票用我们做CD或发票用我们做CD或发票用我们做CD或发票用我们做CD或发票用我们
                                做CD或发票用我们做CD或发票用我们做CD或发票用我们做CD或发票用我们做CD或发票用我们做CD或发票用我们...
                            <span class="Dt_more"><a href="">详细>></a></span></p>
                        </dd>
                    </dl>
                    <dl>
                        <dt><a href="">其他资料我们会帮您提供</a></dt>
        ...
        <div class="Md_right">
            ...
            <div class="big_a">
                <ul>
                    <li class="big_one"><a href="http://video.sina.com.cn/v/b/117304418-2976835390.html?qq-pf-to=pcqq.c2c">认证视频</a></li>
                    <li class="big_two"><a href="">诚信通在线</a></li>
                    <li class="big_thr"><a href="">诚信通如何交易</a></li>
                    <li class="big_four"><a href="http://mike2010000.1688.com/page/creditdetail.htm">实地认证</a></li>
                </ul>
            </div>
            <div class="Md_r1">
                ...
                <div class="Mdr1_con">
                	<dl>
                    	<dt><a href=""><img src="__PUBLIC__/images/rzimages/usa.jpg" /></a></dt>
                        <dd>美国</dd>
                    </dl>
                    <dl>
                    	<dt><a href=""><img src="__PUBLIC__/images/rzimages/usa.jpg" /></a></dt>
