 ...
 <body>
	<div class="header">
        ...
        <div class="logo_search">
        	<div class="logo"><a href=""><img src="__PUBLIC__/Home/images/rzimages/logo.jpg" /></a></div>
            <div class="search">
    ...
    <div class="M_caut">
        ...
        <div class="caut">
        	<div class="caut_tit">
                ...
                <ul>
                	<li class="nextbtn0"><a href="<?php echo U('Index/RzCountry/rzList');?>">全部</a></li>
                    <li class="a_sx"></li>
					
                    <li class="nextbtn"><a href="<?php echo U('Index/RzCountry/rzMain');?>">常见使馆认证</a></li>
                    <li class="a_sx"></li>
					
                    <li class="nextbtn2"><a href="">单证认证</a></li>
                    <li class="a_sx"></li>
					
                    <li class="nextbtn3"><a href="<?php echo U('Index/RzCountry/gg_aut');?>">各国使馆认证</a></li>
                </ul>
            </div>
			
            <div class="caut_con online_11">
            	<ul> 		
				        <?php if(is_array($emb)): $i = 0; $__LIST__ = $emb;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href=""><?php echo ($vo["name"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
            	</ul>
                <div class="clear"></div>
            </div>
			
			<!--<div class="caut_con online_12" >
            	<ul> 
				         <?php if(is_array($emb2)): $i = 0; $__LIST__ = $emb2;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo2): $mod = ($i % 2 );++$i;?><li><a href=""><?php echo ($vo2["name"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
            	</ul>
                <div class="clear"></div>
            </div>
			
			
			<div class="caut_con online_13">
            	<ul> 
				         <?php if(is_array($emb3)): $i = 0; $__LIST__ = $emb3;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo3): $mod = ($i % 2 );++$i;?><li><a href=""><?php echo ($vo3["name"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
            	</ul>
                <div class="clear"></div>
            </div>
			-->
