    ...
    <div class="M_xnews">
        ...
        <div class="xnews_left">
        	<div class="xnewsl_tit">
                ...
                <p class="sj">时间：<?php echo ($detail["addtime"]); ?>　来源：<?php if($detail['comfrom'] == 0): ?>速格<?php else: echo ($detail["comfrom"]); endif; ?>　作者：<?php echo ($detail['rootUser']['rootName']); ?>  浏览次数：<?php echo ($detail["traffic"]); ?></p>
            </div>
