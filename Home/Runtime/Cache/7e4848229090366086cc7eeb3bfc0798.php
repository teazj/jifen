        ...
        <div class="navbg">
        	<div class="nav">
            	<ul>
                    ...
                    <li><a href="<?php echo U('Index/Index/index','','');?>">商城首页</a></li>
                    <li class="shuxian"></li>
                    <li><a href="jifen.bak/index.php/Index/ShopGetGift/index">积分获取</a></li><!--<?php echo U('Index/ShopGetGift/index','','');?>-->
                    <li class="shuxian"></li>
                    <li><a href="jifen.bak/index.php/Index/Vip/index">我的积分</a></li><!--<?php echo U('Index/Vip/index');?>-->
                    <li class="shuxian"></li>
                    <li><a href="">热门兑换</a></li>
                    <li class="shuxian"></li>
 ...
 <div class="footer">
    	<div class="linkbg">
        	<div class="footer-con">
                <div class="min-nav">
                	<dl>
                    	<dt class="xinshou"><h4><a href="<?php echo U('Index/Help/help');?>">新手上路</a></h4></dt>
                        <dd><a href="<?php echo U('Index/Help/help');?>">客户登陆</a></dd>
                        <dd><a href="<?php echo U('Index/Help/help');?>">10000知道</a></dd>
                    </dl>
                    <dl>
                    	<dt class="peisong"><h4><a href="<?php echo U('Index/Help/help');?>">配送服务</a></h4></dt>
                        <dd><a href="<?php echo U('Index/Help/help');?>">配送时限/范围</a></dd>
                        <dd><a href="<?php echo U('Index/Help/help');?>">礼品签收注意事项</a></dd>
                        <dd><a href="<?php echo U('Index/Help/help');?>">关于订单拆分</a></dd>
                        <dd><a href="<?php echo U('Index/Help/help');?>">配送流程</a></dd>
                    </dl>
                    <dl>
                    	<dt class="shouhou"><h4><a href="<?php echo U('Index/Help/help');?>">售后服务</a></h4></dt>
                        <dd><a href="<?php echo U('Index/Help/help');?>">配送时限/范围</a></dd>
                        <dd><a href="<?php echo U('Index/Help/help');?>">礼品签收注意事项</a></dd>
                        <dd><a href="<?php echo U('Index/Help/help');?>">关于订单拆分</a></dd>
                        <dd><a href="<?php echo U('Index/Help/help');?>">配送流程</a></dd>
                    ...
                    <dl>
                    	<dt class="help"><h4><a href="<?php echo U('Index/Help/help');?>">帮助中心</a></h4></dt>
                        <dd><a href="<?php echo U('Index/Help/help');?>">配送时限/范围</a></dd>
                        <dd><a href="<?php echo U('Index/Help/help');?>">礼品签收注意事项</a></dd>
                        <dd><a href="<?php echo U('Index/Help/help');?>">关于订单拆分</a></dd>
                        <dd><a href="<?php echo U('Index/Help/help');?>">配送流程</a></dd>
