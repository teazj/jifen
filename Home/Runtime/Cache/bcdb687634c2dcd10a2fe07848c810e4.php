...
<div class="header_topbg">
    ...
    <div class="M_xq">
    	<div class="Mcaut_tit"><a href="">首页</a> > <a href="">签证</a> > <a href=""><?php echo ($vo["name"]); echo ($vo["catename"]); ?></a> > <a href=""><?php echo ($vo["name"]); echo ($vo["catename"]); echo ($vo["desc"]); ?></a></div>
        <div class="gm_right">
        	<div class="Mxq_r1">
            	...
            	<div class="Mxqr1_con">
                	<div class="r1_left">
                    	<div class="guoqi">
                        	<img src="__PUBLIC__/Admin/Images/Vista/m_<?php echo ($vo["logo"]); ?>"/>
                            <div class="guoqi_yy"></div>
                        </div>
                        <div class="xq_xx">
                        	<ul>
								<li>速格价格：¥<span class="red_18"><?php echo ($a[0]); ?></span></li>
							<?php if(is_array($a)): $k = 0; $__LIST__ = array_slice($a,1,null,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo2): $mod = ($k % 2 );++$k;?><li style="display:none">速格价格：¥<span class="red_18"><?php echo ($vo2); ?></span></li><?php endforeach; endif; else: echo "" ;endif; ?>
                            </ul>
                    ...
                    <div class="r1_right">
                    	<ul>
                            ...
                            <li><span class="f_hw">产品名称：</span><?php if(is_array($b)): $k = 0; $__LIST__ = $b;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo1): $mod = ($k % 2 );++$k;?><span class="af"><a onclick="price(<?php echo ($k-1); ?>)"><?php echo ($vo1); ?></a></span><?php endforeach; endif; else: echo "" ;endif; ?></li>
                            <form action="<?php echo U('Index/Qzorder/index');?>" method="post">
								...
								<li class="ri_inp1bg"><?php if($Think.session.loginuser): ?><input type="submit" value="立即办理" class="r1_inp1 banli" /><?php else: ?><input type="button" onclick="window.location='__APP__/Com/login';" value="登录后可办理" class="r1_inp1 banli" /><?php endif; ?></li>
							</form>
                        </ul>
                    </div>
                </div>
				<script>
					...
					$('.xq_se1').change(function(){
						var url="<?php echo U('Index/Details/info');?>";
