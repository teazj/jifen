...
<script type="text/javascript" src="__PUBLIC__/Home/js/toptab.js"></script>
 ...
 <body>
    ...
    <div class="M_download">
    	<div class="Mcaut_tit"><a href="">首页</a> > <a href="javascript:void()">资料下载</a></div>
        <div class="Md_left">
        	<div class="Md_ltit"><a href="<?php echo U('Index/DownData/download','','');?>">资料下载</a></div>
            <div class="Md_lcon">
            <?php if(is_array($files)): foreach($files as $key=>$vo): ?><ul>
                	<li><?php echo ($vo['fileTitle']); ?></li>
                    <li><a href="__PUBLIC__/rzzl/<?php echo ($vo['upfile']); ?>">[点击下载]</a></li>
